...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
		...
		[TestMethod]
		public void ColourTestFunction()
		{
			Colour c = new Colour(0x94, 0x00, 0x00, 0x00);

			c.SetGreen(c.GetRed());

			Assert.AreEqual<byte>(c.GetGreen(), 0x94);
		}
	}
}
